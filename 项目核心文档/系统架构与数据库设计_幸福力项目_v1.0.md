...
| answers | JSON | 原始答卷数据 |
| **result_data** | JSON | 结构化结果：<br>九型: `{top3: ["5", "3", "8"], percentages: {"1":0.1, ...}, sortedTypes: [...], matchableOppositeCount: 5}`<br>依恋: `{type: "得分不足", anxietyScore: 2, avoidanceScore: 1, securityScore: 1}`<br>幸福力: `{totalScore: 156, dimensions: [{id:1, score:8, normalizedScore: 8}, ...]}` |
| created_at | DATETIME | |
