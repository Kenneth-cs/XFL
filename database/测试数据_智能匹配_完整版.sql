...
-- =====================================================
/*
DELETE FROM assessment_record WHERE user_id LIKE 'XFL001000%';
DELETE FROM app_user_profile WHERE user_id LIKE 'XFL001000%';
DELETE FROM app_user WHERE id LIKE 'XFL001000%';
*/
